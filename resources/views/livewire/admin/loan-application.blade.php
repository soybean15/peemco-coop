        ...
        <div class="grid gap-6 sm:grid-cols-2">
            ...
            <div class="relative overflow-hidden transition-all bg-white border border-gray-200 rounded-lg hover:shadow-lg">
                ...
                <div class="p-6 border-t border-gray-200 bg-gray-50">
                    <a href="{{ route('admin.loan-regular') }}" class="inline-block w-full px-4 py-2 font-semibold text-center text-white transition duration-300 ease-in-out bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50">
                        Proceed
                    </a>
                </div>
            </div>
            ...
            <div class="relative overflow-hidden transition-all bg-white border border-gray-200 rounded-lg hover:shadow-lg">
                ...
                <div class="p-6 border-t border-gray-200 bg-gray-50">
                    <a href="{{ route('admin.loan-cash-advance') }}" class="inline-block w-full px-4 py-2 font-semibold text-center text-white transition duration-300 ease-in-out bg-teal-600 rounded-md hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50">
                        Proceed
                    </a>
                </div>
            </div>
